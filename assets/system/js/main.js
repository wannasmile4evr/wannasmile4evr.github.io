...
(() => {
  ...
  function initElements() {
    ...
    window.config = {
      ...
      sheetUrl:         "https://script.google.com/macros/s/AKfycbyPkLa-93PUcjMq4lUk2tIkL8DFp5jLTC0zZAXpazZyhJJKzucp1zxZISu-TXUo0PU/exec",
      devBuildUrl:      "",
    };
    ...
    window.stickerPacksLibrary = [
      {
        name:    "wannasmile4evr",
        static:  "https://raw.githubusercontent.com/wannasmile4evr/wannasmile4evr.github.io/main/assets/media/stickers/static/",
        dynamic: "https://raw.githubusercontent.com/wannasmile4evr/wannasmile4evr.github.io/main/assets/media/stickers/dynamic/",
      },
    ];
...
<body>
  ...
  function initPaging() {
    ...
    window.filterAssets = (q) => {
      ...
      for (const c of window._allCards) {
        const catOk = !activeCategory
          ...
          || c.dataset.subcategory === activeCategory;

        if (!catOk) { c.dataset.filtered = "false"; continue; }
      ...
      if (isSearching || activeCategory) {
        ...
        if (pageIndicator) {
          pageIndicator.textContent = isSearching && activeCategory
            ? "Searching within tag…"
            : (isSearching ? "Searching all pages…" : "Browsing all pages…");
        }
    ...
    (function initSubHeaderFilter() {
      ...
      function setActiveCategory(cat) {
        ...
        allBtns.forEach(b => b.classList.toggle("active", activeCategory && b.dataset.category === activeCategory));
      ...
      function refreshCategoryDropdown() {
        ...
        const cats = new Set();
        const subs = new Set();
        for (const a of (window.assetsData || [])) {
        ...
        const buildItem = (label, list) => {
          ...
          if (activeCategory && el.dataset.category === activeCategory) el.classList.add("active");
  ...
  const SEARCH_QUOTES_URL = "assets/system/json/searchQuotes.json";
